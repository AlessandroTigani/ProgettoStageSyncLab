      ...
      accept: () => {
        this.profileService.deleteUser(this.userId)
          .subscribe(
            ...
            (error) => {
              this.messageService.add({ severity: 'error', summary: 'Errore', detail: 'Errore durante l\'eliminazione dell\'account', life: 3000 });
              console.error('Errore nella chiamata di eliminazione:', error);
            }
          );
      },
      reject: () => {
